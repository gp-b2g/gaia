...
if ( !('BuildingBlocks' in window) ) {
	BuildingBlocks = {};
}

BuildingBlocks.switches = function() {

	var self = BuildingBlocks.switches;
	// Events
	...
	self.bind = function(id) {
		// Check if there is a defined area where to look for our elements
		var area = document.getElementById(id);
		if (!area) {
			area = document.body;
		}
		var rootElm = area.querySelectorAll("[data-type=switch]");
